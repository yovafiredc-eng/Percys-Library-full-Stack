...
function buildCatalog(): AchievementDef[] {
  ...
  const extras: AchievementDef[] = [
    ...
    {
      id: "secret-percys-milestone",
      title: "🔥 Percy's Milestone",
      description: "25,000 páginas leídas totales. ¡Eres una leyenda!",
      group: "secret",
      tier: 5,
      secret: true,
      check: (c) => c.totalPages >= 25_000,
    },
    {
      id: "secret-night-owl",
      title: "🌙 Nocturno Obsesionado",
      description: "Lee 500 páginas en un solo día. ¿Dormiste algo?",
      group: "secret",
      tier: 5,
      secret: true,
      check: (c) => c.bestDayPages >= 500,
    },
    {
      id: "secret-perfect-collector",
      title: "💎 Coleccionista Perfecto",
      description: "500 cómics favoritos. Tienes gusto excelente.",
      group: "secret",
      tier: 5,
      secret: true,
      check: (c) => c.favorites >= 500,
    },
    {
      id: "secret-power-user",
      title: "⚡ Power User Legendario",
      description: "365 racha de lecturas + 50,000 páginas + 100 favoritos.",
      group: "secret",
      tier: 5,
      secret: true,
      check: (c) => c.longestStreak >= 365 && c.totalPages >= 50_000 && c.favorites >= 100,
    },
  ];
