          ...
          <section className="hidden w-full flex-col gap-4 overflow-y-auto lg:flex lg:w-[45%]">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                {
                  title: "Lee",
                  desc: "5 modos de lectura",
                  icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>,
                },
                {
                  title: "Sigue",
                  desc: "Progreso y stats",
                  icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 20v-6M6 20V10M18 20V4"/></svg>,
                },
              ].map(({ title, desc, icon }) => (
                <div
                  key={title}
