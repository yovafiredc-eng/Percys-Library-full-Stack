      ...
      <div className="max-w-6xl mx-auto space-y-10 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="pl-card p-8 flex flex-col justify-center items-center text-center bg-gradient-to-br from-blue-600/10 to-transparent border-blue-500/20 shadow-lg shadow-blue-500/5">
            <div className="mb-2"><svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-rose-400"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"/></svg></div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatCard icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>} label="Colección" value={stats.totalComics} sub="cómics" />
          <StatCard
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          />
          <StatCard
            icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M23 6l-9.5 9.5-5-5L1 18"/><path d="M17 6h6v6"/></svg>}
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 md:px-8 py-10">
      <div className="max-w-6xl mx-auto space-y-10 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 pl-card p-8 flex items-center gap-10">
            <SkeletonPulse className="h-32 w-32 rounded-full shrink-0" />
          ...
          <div className="pl-card p-8 flex flex-col justify-center items-center text-center space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="pl-card p-5 space-y-3">
        ...
        <div className="space-y-3">
          ...
          <div className="pl-card p-6 space-y-2">
            <div className="flex gap-1">
              {Array.from({ length: 30 }).map((_, i) => (
                <SkeletonPulse key={i} className="h-8 w-3 rounded-sm" />
              ))}
            </div>
            <div className="flex gap-1">
              {Array.from({ length: 30 }).map((_, i) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            ...
            <div className="pl-card p-6 space-y-3">
