...
export interface SettingsDto {
  ...
  imageFilter: "none" | "sepia" | "warm" | "cool" | "night" | "high-contrast" | "grayscale" | "paper";
...
export const api = {
  ...
  resetProfile: () =>
    jsonFetch<{ ok: boolean; settings: SettingsDto }>("/api/settings/reset-profile", { method: "POST" }),
