...
export function Toaster() {
  ...
  return (
    <div className="pointer-events-none fixed top-4 left-4 right-4 sm:top-6 sm:right-6 sm:left-auto z-[100] flex flex-col items-stretch sm:items-end gap-2 max-w-[calc(100vw-2rem)] sm:max-w-[calc(100vw-3rem)]">
      {toasts.length > 1 && (
        <button
          type="button"
          onClick={clear}
