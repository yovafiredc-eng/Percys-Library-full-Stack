...
export function NextComicPrompt({ next, visible, uiVisible, onOpen, onDismiss }: Props) {
  ...
  return (
    <div
      className={clsx(
        "reader-overlay pointer-events-auto absolute bottom-28 left-4 right-4 sm:left-auto sm:right-4 z-30 sm:max-w-xs rounded-xl bg-ink-800/95 p-3 shadow-soft ring-1 ring-ink-700 backdrop-blur",
