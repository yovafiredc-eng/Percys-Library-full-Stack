...
**Lector de cómics moderno, rápido, minimalista + ⚡ Optimizaciones de rendimiento críticas.**

## 🚀 ¿Qué hay de nuevo? (Versión 0.3.0)

✨ **15+ Nuevas Features Masivas**:
- **Búsqueda Avanzada** - Filtros por formato, estado, categorías
- **Dashboard de Estadísticas** - Métricas, progreso, tiempo de lectura
- **Listas de Lectura** - Por Leer, Leyendo, Completados + personalizadas
- **Exportar Datos** - CSV, JSON, Reportes
- **Modo Oscuro/Claro** - Toggle en header + auto-detect
- **Bookmarks** - Guardar páginas favoritas con notas
- **Imágenes con Blur-Up** - Progressive loading
- **Infinite Scroll** - Carga automática
- **Recomendaciones Inteligentes** - Basadas en favoritos
- **Batch Operations** - Gestiona múltiples cómics
- **Múltiples Vistas** - Grid, List, Kanban, Timeline
- **Auto-Organización** - Sugiere categorías
- **Atajos de Teclado** - Referencia completa
- **Quick Stats** - Resumen visual
- **Trending Comics** - Populares + siguientes a leer

📊 [Ver todas las features](./FEATURES_GUIDE.md) | 📖 [Changelog técnico](./IMPROVEMENTS_v0.3.0.md)

---

## 🚀 ¿Qué hay de nuevo? (Versión 0.2.0)

✨ **3 Mejoras de Rendimiento Críticas**:
- **Compresión WebP Agresiva** (-55% tamaño covers, -50% ancho de banda)
- **Virtual Scrolling** (-80% DOM nodes, -60% memoria, 60 FPS)
- **Service Worker & PWA** (Offline support, -90% repeat downloads, installable)

✨ **4 Logros Secretos Nuevos**:
- 🔥 **Percy's Milestone**: 25,000 páginas leídas
- 🌙 **Nocturno Obsesionado**: 500 páginas en un día
- 💎 **Coleccionista Perfecto**: 500 cómics favoritos
- ⚡ **Power User Legendario**: 365 racha + 50K páginas + 100 favoritos

📚 **Lector de cómics full-stack**: React + TypeScript + Tailwind + Zustand en el frontend, Express + Prisma + PostgreSQL (Supabase) en el backend.
